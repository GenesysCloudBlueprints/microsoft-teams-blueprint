...
#  Enable a Microsoft Teams meeting
...
![Microsoft Teams Agent View](/bpTeamsAgent.png)
...
![Microsoft Teams Integration](/bpTeamsSystem.png)
...
![New Registration for an Azure app](./0ACreateNewAzureAppRegistration.png)
...
![Web Services Data Actions in Genesys Cloud Integrations Search](./1AWebServicesDataActionInstall.png)

2. Rename the Web Services Data Action with your desired name and provide a short description.

![Rename and describe the Web Services Data Action](./1BRenameWebServicesDataAction.png)

3. Navigate to **Configuration > Credentials** and click **Configure**.

![Navigate to Configuration -> Credentials -> Configure](./1CConfigurationCredentials.png)
...
![Create fields and values](./1DFieldsandValues.png)
...
![Custom Auth Data Action associated with Web Services Data Actions Integration](./1ECustomAuthDataAction.png)
...
![Open Custom Authentication Data Action](./1FOpenCustomAuthDataAction.png)

![Import Custom Authentication Data Action](./1GImportCustomAuthDataAction.png)
...
![Add an OAuth Client](./2AAddOAuthClient.png)
...
![Setup OAuth Client](./2BOAuthClientSetup.png)
...
![OAuth Client Credentials](./2COAuthClientCredentials.png)
...
![Import Data Action](./4AImportDataActions.png)
...
![Import Create Teams Video Meeting Data Action](./4BImportCreateTeamsVideoMeetingDataAction.png)
...
![Import Send SMS Data Action](/5BImportSendSMSDataAction.png)
...
![Test Create Teams Video Meeting URL Data Action](./7TestCreateTeamsVideoMeetingURLDataAction.png)
